...
namespace HWAPI
{
    ...
    {
        public VersionsTableCarInfo(string colNumber, string year, string series, string color, string tampo, string baseColor, string windowColor, string interiorColor, string wheelType, string toyNumber, string country, string notes, Texture2D photo)
        {
            ColNumber = colNumber;
            Year = year;
            Series = series;
